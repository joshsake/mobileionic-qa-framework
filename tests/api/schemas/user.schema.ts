 ...
 */
export const loginResponseSchema: JSONSchemaType<LoginResponseSchema> = {
  type: 'object',
  properties: {
 ...
 */
export const userProfileSchema: JSONSchemaType<UserProfileSchema> = {
  type: 'object',
  properties: {
    id: { type: 'number' },
    email: { type: 'string', format: 'email' },
 ...
 */
export const errorResponseSchema: JSONSchemaType<ErrorResponseSchema> = {
  type: 'object',
  properties: {
